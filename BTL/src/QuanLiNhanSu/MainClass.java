        ...
        do{
            ...
            switch(choose){
                ...
                case 3:
                    ...
                    for (Map.Entry<Integer, NhanVienFullTime> entry : lhm.entrySet()) {
                        Integer key = entry.getKey();
                        NhanVienFullTime value = entry.getValue();
                        value.tinhLuong();
                        value.showInfor();
                    }

                    System.out.println("\n\n\n Thông tin nhân viên part time: \n\n");
                    Set col = lhm1.entrySet();
                    for (Map.Entry<Integer, NhanVienPartTime> entry : lhm1.entrySet()) {
                        Integer key = entry.getKey();
                        NhanVienPartTime value = entry.getValue();
                        value.tinhLuong();
                        value.showInfor();
                    }
                    break;
//                      Set<Map.Entry<Integer, DiaDanh>> set = lhm.entrySet();
//        ArrayList<Map.Entry<Integer, DiaDanh>> list = new ArrayList<>(set);
//        System.out.println("Địa danh có giá tham quan cao nhất là: "+Collections.max(list, new Comparator<Map.Entry<Integer, DiaDanh>>(){
//            @Override
//            public int compare(Map.Entry<Integer, DiaDanh> o1, Map.Entry<Integer, DiaDanh> o2) {
//                if(o1.getValue().getGiaThamQuan()>o2.getValue().getGiaThamQuan())
//                    return 1;
//                else if(o1.getValue().getGiaThamQuan()>o2.getValue().getGiaThamQuan())
//                    return 0;
//                else
//                    return -1;
...
//        }));
//                case 4:
//                 Set<Map.Entry<Integer, NhanVienFullTime>> set = lhm.entrySet();
